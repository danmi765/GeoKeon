...
CREATE TABLE `board_notice` (
  `BOARD_NOTICE_ID` int(11) NOT NULL,
  `BOARD_NOTICE_TITLE` varchar(50) DEFAULT NULL,
  `BOARD_NOTICE_CONTENT` text,
  `BOARD_NOTICE_WRITER` varchar(10) DEFAULT NULL,
  `BOARD_NOTICE_DATE` date DEFAULT NULL,
