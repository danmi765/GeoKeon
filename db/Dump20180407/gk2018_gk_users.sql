...
CREATE TABLE `gk_users` (
  ...
  `GK_USERS_NAME` varchar(20) DEFAULT NULL,
  `GK_USERS_EMAIL` varchar(50) NOT NULL,
  `GK_USERS_PHONE` varchar(11) NOT NULL,
  `GK_USERS_DATE` date DEFAULT NULL,
...
LOCK TABLES `gk_users` WRITE;
/*!40000 ALTER TABLE `gk_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `gk_users` ENABLE KEYS */;
UNLOCK TABLES;
