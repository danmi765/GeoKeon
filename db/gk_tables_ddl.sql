...
CREATE TABLE IF NOT EXISTS `GK2018`.`PORTPOLIO` (
  `POTRPOLIO_ID` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `GK2018`.`BOARD_INQUIRY` (
  `BOARD_INQUIRY_ID` INT NOT NULL AUTO_INCREMENT,
  ...
  `BOARD_INQUIRY_DATE` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `GK2018`.`BOARD_NOTICE` (
  ...
  `BOARD_NOTICE_DATE` DATETIME NULL,
