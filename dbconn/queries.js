module.exports = {
    'select' : {
        'list_comm_board' : 'SELECT * FROM BOARD WHERE BOARD_DOMAIN_ID = ? ORDER BY DATE DESC' ,
    ...
    'delete' : {
        'delete_comm_board' : 'DELETE FROM BOARD WHERE BOARD_ID = ?',
        'delete_comment' : 'DELETE FROM COMMENT WHERE COMMENT_ID = ?'
    },
    'update' : {
        'update_baord_content' : 'UPDATE BOARD SET TITLE=?,   CONTENT= ? WHERE BOARD_ID= ? ',
